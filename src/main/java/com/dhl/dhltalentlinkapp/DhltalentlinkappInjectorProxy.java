 ...
 * @author dhl
 */
public final class DhltalentlinkappInjectorProxy implements InjectorProxy {
    
    @Override
    public boolean isApplicable(Class<?> clazz) {
        return InjectorProxy.samePackageOrBelow(DhltalentlinkappInjectorProxy.class).test(clazz);
    }
